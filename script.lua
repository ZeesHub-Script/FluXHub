loadstring(game:HttpGet("https://raw.githubusercontent.com/ZeesHub-Script/Settings/refs/heads/main/FastMax.lua.txt"))()
do
  ply = game.Players
  plr = ply.LocalPlayer
...
toggleButton.Image = "rbxassetid://112091983584684"
...
local Tabs = {
  Main = Window:AddTab({Title = "Tab Farming", Icon = "rbxassetid://125282832400042"}),
  Settings = Window:AddTab({Title = "Tab Setting Farm", Icon = "rbxassetid://125282832400042"}),
  Melee = Window:AddTab({Title = "Tab Auto Get Melee V2", Icon = "rbxassetid://125282832400042"}),
  ...
  Travel = Window:AddTab({Title = "Tab Teleport", Icon = "rbxassetid://125282832400042"}),
  Fruit = Window:AddTab({Title = "Tab Fruits", Icon = "rbxassetid://125282832400042"}),
  Shop = Window:AddTab({Title = "Tab Shop", Icon = "rbxassetid://125282832400042"}),
  Misc = Window:AddTab({Title = "Tab Misc", Icon = "rbxassetid://125282832400042"})
}
...
RandomFF = Tabs.Fruit:AddToggle("RandomFF", {Title = "Auto Random Devil Fruit", Description = "Automatic Random Devil Fruit", Default = false})
...
Tabs.Misc:AddButton({Title = "Copy Job ID", Description = "",Callback = function()
...
DisbleChat = Tabs.Misc:AddToggle("DisbleChat", {Title = "Disable Chat UI", Description = "", Default = false})
...
DisbleLeaderB = Tabs.Misc:AddToggle("DisbleLeaderB", {Title = "Disable Leaderboard UI", Description = "", Default = false})
